...
<div class="page bk_content" style="top:0;">
    <div class="addWrap">
        <div class="swipe" id="mySwipe">
            ...
            @foreach($pdt_images as $pdt_image)
                <div>
                    <a href="javascript:;">
                        <img class="img-responsive" src="{{url($pdt_image->image_path)}}"/>
                    </a>
                </div>
                @endforeach
        </div>
    ...
    <div class="bk_fix_bottom">
        ...
        <div class="bk_half_area">
            <button class="weui_btn weui_btn_default" onclick="_toCart()">查看购物车
                (<span id="cart_num">{{$count}}</span>)
            </button>
        </div>
...
@section('my-js')
    <script type="text/javascript" src="{{url('/js/swipe.min.js')}}" charset="UTF-8"></script>
