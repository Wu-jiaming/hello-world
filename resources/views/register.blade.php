...
<div class="weui_cells weui_cells_radio">
    ...
    <div class="weui_cells weui_cells_form">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input type="password" class="weui_input"  placeholder="不少于6位" name="passwd_phone"/>
            </div>
        </div>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input type="password" class="weui_input" placeholder="不少于6位"  name="passwd_phone_cfm"  />
            </div>
        </div>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input type="text" class="weui_input" placeholder="" name="phone_code"/>
            </div>
    ...
    <div class="weui_cells weui_cells_form" style="display:none;">
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input class="weui_input" name="passwd_email" type="password" placeholder="不少于6位"/>
            </div>
        </div>
        ...
        <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <input type="password" class="weui_input" name="passwd_email_cfm" placeholder="不少于6位"/>
            </div>
        </div>
        ...
        <div class="weui_btn_area">
            <a class="weui_btn weui_btn_primary" href="javascript:"
               onclick="onRegisterClick();">注册</a>
        </div>

        <a href="{{url('/login')}}" class="bk_bottom_tips bk_important">
            已有账号？去登陆
        </a>
...
@section('my-js')
    ...
    function onRegisterClick(){
        //便利输出input中类型是radio的名字为register_type
    ...
    function verifyPhone(phone,password,confirm,phone_code) {
        ...
        if(password.length < 6 || confirm.length <6 ||password.length > 20 || confirm.length >20){
            $('.bk_toptips').show();
            $('.bk_toptips span').html('密码不得小于6位和大于20位');
            setTimeout(function () {
                $('.bk_toptips').hide();
            },2000);
            return false;
