...
<form class="form form-horizontal" id="form-category-edit">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" value="{{$category_edit->name}}" placeholder="" id="" name="name">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>序号：</label>
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" autocomplete="off" value="{{$category_edit->id}}" placeholder="" id="" name="category_no">
        </div>
    </div>
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="parent_id" size="1">
                ...
                @foreach($categories as $category)
                    ...
                    @if($category_edit->parent_id == $category->id )
                    <option value="{{$category->id}}" selected="selected">{{$category->name}}</option>

			        @elseif($category_edit->id != $category->id)
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-4 col-sm-5">
            @if($category_edit->preview != null)
                <img id="preview_id" src="{{url($category_edit->preview)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id').click()"/>

            @elseif($category_edit->preview == null)
