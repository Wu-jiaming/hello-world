...
<form class="form form-horizontal" id="form-product-add">
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-4">
            <input type="text" class="input-text" value="{{$product_edit->name}}" placeholder="" id="" name="name">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>简介：</label>
        <div class="formControls col-xs-8 col-sm-4">
            <input type="text" class="input-text" autocomplete="off" value="{{$product_edit->summary}}" placeholder="" id="" name="summary">
        </div>
    </div>
    <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>价格：</label>
        <div class="formControls col-xs-8 col-sm-4">
            <input type="text" class="input-text" value="{{$product_edit->price}}" placeholder="" id="" name="price">
        </div>
    </div>
    <div class="row cl">
        ...
        <select class="select" name="category_id" size="1">
            ...
            @foreach($categories as $category)
                @if($category->id == $product_edit->category_id)
                <option value="{{$category->id}}" selected="selected">{{$category->name}}</option>
                @elseif($category->id == $product_edit->category_id)
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-4 col-sm-5">
            <img id="preview_id" src="{{url($product_edit->preview)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id').click()"/>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-4 col-sm-8">
            @if($pdt_images != null)
                ...
                @if($pdt_image->image_no == 1)
                <img id="preview_id1" src="{{url($pdt_image->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id1').click()"/>
                ...
                @endif
                    @if($pdt_image->image_no == 2)
                        <img id="preview_id2" src="{{url($pdt_image->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id2').click()"/>
                    ...
                    @endif
                    @if($pdt_image->image_no == 3)
                        <img id="preview_id3" src="{{url($pdt_image->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id3').click()"/>
                    ...
                    @endif
                    @if($pdt_image->image_no == 4)
                        <img id="preview_id4" src="{{url($pdt_image->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id4').click()"/>
                    ...
                    @endif
                    @if($pdt_image->image_no == 5)
                        <img id="preview_id5" src="{{url($pdt_image->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id5').click()"/>
                ...
                @endforeach
{{--
                    @if($pdt_images->image_no == 2)
                        <img id="preview_id2" src="{{url($pdt_images->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id2').click()"/>
                        <input type="file" name="file" id="input_id2" style="display: none;" onchange="return uploadImageToServer('input_id2','images','preview_id2')"/>
                    @endif

                    @if($pdt_images->image_no == 3)
                        <img id="preview_id3" src="{{url($pdt_images->image_path)}}" style="border: 1px solid #B8B9B9; width: 100px;height: 100px; cursor: pointer;" onclick="$('#input_id3').click()"/>
                        <input type="file" name="file" id="input_id3" style="display: none;" onchange="return uploadImageToServer('input_id3','images','preview_id3')"/>
                    @endif--}}
            @else
